    ...
    */
    ...
    for (int n=len-1;n>=0;n--){
        ...
        //else if 'close bracket'
            ...
            //if the top of stack is not 'close bracket' then move operators to prefix
            ...
            //compare precedence
            while (!isEmptyStack(&s) && (peek(&s)!='(' || peek(&s)!=')') && precedence(peek(&s))>precedence(x)){
                prefix[count++]=pop(&s);
            }
            push(&s, x);
